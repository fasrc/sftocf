...
class ColdFrontDB:
    ...
    def pull_sf(self, volume=None):
        ...
        # 2. produce list of files that have been collected and list of lab/volume/
        # filename tuples to collect
    ...
    def push_cf(self, filepaths, clean):
        for f in filepaths:
            ...
            if Allocation.MultipleObjectsReturned.count() > 1:
                logger.warning(f"WARNING: Multiple allocations found for project id {project.id}, resource {resource}. Updating the first.")
